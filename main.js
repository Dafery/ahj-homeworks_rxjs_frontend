...
;// CONCATENATED MODULE: ./src/js/components/MessagesItem.js
...
class MessagesItem {
  getMessagesItem(message) {
    const itemEl = createElementFromHTML(`<li class="messages-list__item">
      ...
      <span class="messages-list__item-created">${moment_default()(message.received).format('HH:mm DD.MM.YYYY')}</span>  
    </li>`);
    return itemEl;
  }
